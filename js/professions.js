// Функция отображения карточек профессий с фильтром по категории
...
// Переход на страницу детального просмотра профессии
...
// Инициализация – показываем все профессии
